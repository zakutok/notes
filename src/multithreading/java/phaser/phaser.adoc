...
Конструкція Phaser узагальнює собою CountDownLatch і Semaphore, а також має свої особливості оскільки може використовуватися для змінної кількості учасників (потоків) під час роботи.
