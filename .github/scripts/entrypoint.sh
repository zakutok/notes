...
INPUT_SOURCE_DIR=.
INPUT_SLIDES_SKIP_ASCIIDOCTOR_BUILD=false
...
if [[ $INPUT_SLIDES_SKIP_ASCIIDOCTOR_BUILD == false ]]; then
    ...
    find . -name "*$INPUT_ADOC_FILE_EXT" -exec asciidoctor -r asciidoctor-multipage -r asciidoctor-diagram -b multipage_html5 -a multipage-level=2 -a text-align=justify $INPUT_ASCIIDOCTOR_PARAMS {} \;
